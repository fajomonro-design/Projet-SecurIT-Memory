...
namespace SecurIT_Memory
{
    public class FormMenu : Form
    {
        ...
        private void InitializeComponentUI()
        {
            ...
            Size = new Size(500, 420); // Fenêtre réduite puisqu'il y a moins d'options
            ...
            // Options de Jeu (Seulement la grille)
            ...
            // Boutons
            btnLancer = new Button { Text = "LANCER LA PARTIE", Font = new Font("Segoe UI", 12F, FontStyle.Bold), Size = new Size(280, 50), Location = new Point(100, 300), BackColor = Color.FromArgb(72, 133, 237), ForeColor = Color.White, FlatStyle = FlatStyle.Flat };
            btnLancer.FlatAppearance.BorderSize = 0;
            btnLancer.Click += BtnLancer_Click;

            Controls.AddRange(new Control[] { lblJ1, txtJoueur1, lblJ2, txtJoueur2, lblGrille, comboGrille, btnLancer });
        }
        ...
        private void BtnLancer_Click(object sender, EventArgs e)
        {
            ...
            // On lance la partie en forçant le thème Jojo
            FormJeu fenetreJeu = new FormJeu(txtJoueur1.Text, txtJoueur2.Text, taille, Theme.Jojo);
